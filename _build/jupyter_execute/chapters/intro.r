...
As you can see, the proper collection and analysis of data are not just for fun (in fact, data collection can become pretty tedious sometimes), nor just a contemporary cliche stating _data matters_. They can result in history-changing developments, improvements in the quality of life, safety,  affordability, and profits. But also, it raises pressing ethical concerns! Although discussion on ethics in the field of data sciences is beyond the scope of this book, it is a topic that is urging more serious attention and debate. 
